...
class Ui_emprunt(object):
    def setupUi(self, Dialog):
        ...
        self.textBrowser_emprunt.setGeometry(QtCore.QRect(520, 380, 221, 171))
        self.textBrowser_emprunt.setObjectName("textBrowser_emprunt")
        self.textBrowser_lst_document = QtWidgets.QTextBrowser(Dialog)
        self.textBrowser_lst_document.setGeometry(QtCore.QRect(290, 380, 221, 171))
        self.textBrowser_lst_document.setObjectName("textBrowser_lst_document")
        self.textBrowser_lst_abonner = QtWidgets.QTextBrowser(Dialog)
        self.textBrowser_lst_abonner.setGeometry(QtCore.QRect(50, 380, 231, 171))
        self.textBrowser_lst_abonner.setObjectName("textBrowser_lst_abonner")
