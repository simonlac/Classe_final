...
class Ui_livre(object):
    def setupUi(self, Dialog):
        ...
        self.label_erreur_livre_t_inv = QtWidgets.QLabel(Dialog)
        self.label_erreur_livre_t_inv.setEnabled(True)
        self.label_erreur_livre_t_inv.setGeometry(QtCore.QRect(10, 330, 361, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.label_erreur_livre_t_inv.setFont(font)
        self.label_erreur_livre_t_inv.setObjectName("label_erreur_livre_t_inv")
        self.label_erreur_annee_2 = QtWidgets.QLabel(Dialog)
        self.label_erreur_annee_2.setEnabled(True)
        self.label_erreur_annee_2.setGeometry(QtCore.QRect(480, 310, 441, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.label_erreur_annee_2.setFont(font)
        self.label_erreur_annee_2.setObjectName("label_erreur_annee_2")
        self.textBrowser_livre = QtWidgets.QTextBrowser(Dialog)
        self.textBrowser_livre.setGeometry(QtCore.QRect(190, 400, 451, 161))
        self.textBrowser_livre.setObjectName("textBrowser_livre")
        self.lineEdit = QtWidgets.QLineEdit(Dialog)
        self.lineEdit.setGeometry(QtCore.QRect(470, 150, 241, 61))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_erreur_livre_t_inv.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ff0000;\">le titre est invalide.</span></p></body></html>"))
        self.label_erreur_annee_2.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ff0000;\">maison d\'édition invalide.</span></p></body></html>"))
