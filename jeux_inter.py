...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.listView_jeux = QtWidgets.QListView(Dialog)
        self.listView_jeux.setGeometry(QtCore.QRect(200, 400, 451, 161))
        self.listView_jeux.setObjectName("listView_jeux")
